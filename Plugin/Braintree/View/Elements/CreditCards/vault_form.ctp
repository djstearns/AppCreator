...
<?php //echo $this->Html->css(!empty($stylesheet) ? $stylesheet : '/Braintree/css/credit_card_form'); ?>
<?php //echo $this->Html->script('/Braintree/js/strtotime'); ?>

<?php 

$this->Helpers->load('Braintree.BraintreeTransparentRedirect');
echo $this->Form->create(
	...
	<fieldset>
		...
		?>
			<a href="https://www.braintreegateway.com/merchants/<?php echo $braintree_merchant_id; ?>/verified" target="_blank"><img src="https://braintree-badges.s3.amazonaws.com/<?php $braintree_badge; ?>.png" border="0" align="right" /></a>
		<?php } ?>
		...
		<div class="select">
			...
			<label><?php echo __('Expiration Date', true); ?></label>
			...
			echo $this->Form->input(
				...
				'dateFormat' => 'M',
				'value' =>$field_expiration_month_options['default'],
				//'options'=>$field_expiration_month_options
				)
			);
			...
			echo $this->Form->input(
				...
				'dateFormat' => 'Y',
				'minYear' => $field_expiration_year_options['minYear'],
				'maxYear' => $field_expiration_year_options['maxYear'],
				'value' => $field_expiration_year_options['default'],
				//'options' => $field_expiration_year_options
				)
			);
